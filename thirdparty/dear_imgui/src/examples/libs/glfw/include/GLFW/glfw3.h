 ...
 *  or screenFrameBuffer hints) is not available on this machine.
 *
...
/*! @brief The function signature for screenFrameBuffer resize callbacks.
 *
 *  This is the function signature for screenFrameBuffer resize callback
 *  functions.
 *
 *  @param[in] window The window whose screenFrameBuffer was resized.
 *  @param[in] width The new width, in pixels, of the screenFrameBuffer.
 *  @param[in] height The new height, in pixels, of the screenFrameBuffer.
 *
 ...
 *
 *  The created window, screenFrameBuffer and context may differ from what you
 *  requested, as not all parameters and hints are
 *  [hard constraints](@ref window_hints_hard).  This includes the size of the
 *  window, especially for full screen windows.  To query the actual attributes
 *  of the created window, screenFrameBuffer and context, see @ref
 ...
 *  screenFrameBuffer of the window in pixels, see @ref glfwGetFramebufferSize.
 *
 *  Any or all of the size arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` size arguments will be set to zero.
 *
 ...
 *  screenFrameBuffer remain unchanged.
 *
...
/*! @brief Retrieves the size of the screenFrameBuffer of the specified window.
 *
 *  This function retrieves the size, in pixels, of the screenFrameBuffer of the
 ...
 *  non-`NULL` size arguments will be set to zero.
 *
 *  @param[in] window The window whose screenFrameBuffer to query.
 *  @param[out] width Where to store the width, in pixels, of the screenFrameBuffer,
 *  or `NULL`.
 *  @param[out] height Where to store the height, in pixels, of the screenFrameBuffer,
 *  or `NULL`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
...
/*! @brief Sets the screenFrameBuffer resize callback for the specified window.
 *
 *  This function sets the screenFrameBuffer resize callback of the specified window,
 *  which is called when the screenFrameBuffer of the specified window is resized.
 *
 *  @param[in] window The window whose callback to set.
 *  @param[in] cbfun The new callback, or `NULL` to remove the currently set
 *  callback.
