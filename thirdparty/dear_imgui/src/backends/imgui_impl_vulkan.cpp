...
{
    // Avoid rendering when minimized, scale coordinates for retina displays (screen coordinates != screenFrameBuffer coordinates)
    ...
    // Will project scissor/clipping rectangles into screenFrameBuffer space
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            {
                // Project scissor/clipping rectangles into screenFrameBuffer space
...
static void ImGui_ImplVulkan_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    ImGui_ImplVulkanH_FrameSemaphores* fsd = &wd->FrameSemaphores[wd->SemaphoreIndex];
    {
...
#endif
        {
            ...
            info.renderPass = wd->RenderPass;
            info.screenFrameBuffer = fd->Framebuffer;
